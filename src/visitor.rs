...
pub trait ExpressionVisitor<T> {
    ...
    fn visit_get(&mut self, name: &str, object: &Expr) -> T;
    fn visit_set(&mut self, name: &str, object: &Expr, value: &Expr) -> T;
...
pub trait StatementVisitor<T> {
    ...
    fn visit_class_declaration(&mut self, ident: &str, methods: &Vec<Stmt>) -> T;
